jQuery(function($){
    ...
    $('.dwqa-search-form').on('input', '.dwqa-search-input', function(event) {
        ...
        timeout = setTimeout( function(){
            if( t.val().length > 2 ) {
                filter_bar.animate({ 'opacity': 0.3 }, 300);
                $('.questions-list').animate({ 'opacity': 0.3 }, 300);
                $('.archive-question-footer').animate({ 'opacity': 0.3 }, 300);
                ...
                filter_bar.animate({ 'opacity': 1 }, 300);
                if( $search ) {
                    if( 'object' == typeof $search ) {
                        $search.abort();
                        $('.dwqa-search-form').find('.icon-remove').hide();
                ...
                $('.questions-list').animate({ 'opacity': 1 }, 300);
                $('.archive-question-footer').animate({ 'opacity': 1 }, 300);
