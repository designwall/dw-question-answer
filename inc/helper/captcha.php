<?php if ( !isset( $_SESSION ) ) session_start(); header("Content-type: image/png");
...
$_SESSION['dwqa']['captcha-form']['verify'] = $hash_md5;

// Verification Image Background Selection
$dir = dirname( __FILE__ ) . '/../../assets/';
$bgs = array(
	$dir . 'img/captcha-1.png',
	$dir . 'img/captcha-2.png',
	$dir . 'img/captcha-3.png'
);
