...
<div class="dwqa-answer-item">
	...
	<div class="dwqa-answer-meta">
		...
		<?php printf( __( '<span><a href="%s">%s%s</a> %s answered %s ago</span>', 'dwqa' ), dwqa_get_author_link( $user_id ), get_avatar( $user_id, 48 ), dwqa_get_author(), dwqa_print_user_badge(), human_time_diff( get_post_time( 'U' ) ) ) ?>
